...
function Upwork({data}) {
  ...
  return (
    <div ref={testimonialsRef} className='bg-white mx-auto pt-[60px] pb-[40px] lg:container px-[20px] md:px-[15px] xl:px-[128px] 2xl:px-[240px]'>
        <Link href="https://www.upwork.com/freelancers/~01de2ada001f8d010c"  target="_blank" rel="noopener noreferrer" className='shadow-lg testimonial-card bg-[#e9f9ff] block rounded-[20px] shadow-[2px 2px 18px 0px rgba(0,0,0,0.49)]-500/50 py-[70px] px-[30px] text-center'>
